...
\textbf{Jointly-owned experiments (I.1--I.3):} \textit{[state which runs / plots are shared with teammates; everything else, and all of I.4 and Part~II, is your own individual work]}.\\
...
Training ran as-shipped (\texttt{run\_tmux.sh} already pointed at our home/venv);
